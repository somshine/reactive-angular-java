...
@Component({
  selector: 'app-auto-load-todo-list',
  templateUrl: './auto-load-todo-list.component.html',
  styleUrls: ['./auto-load-todo-list.component.css']
})
export class AutoLoadTodoListComponent implements OnInit, OnDestroy {
    ...
    this.client.connect().subscribe({
      onComplete: (socket: RSocket) => {
        ...
        socket
          .requestStream({
            data: null,
            metadata: String.fromCharCode('todoListFlux'.length) + 'todoListFlux'
          })
          .subscribe({
